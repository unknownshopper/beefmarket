  ...
  return (
    <div className="min-h-dvh bg-beef-bg">
      ...
      <main className="px-4 pt-4 pb-6 safe-bottom">
        ...
        <div className="space-y-4 rounded-3xl border border-beef-line bg-beef-card p-4">
          <div>
        ...
        <div className="mt-4 rounded-3xl border border-beef-line bg-beef-card p-4">
          <h2 className="text-base font-semibold">Desglose estimado</h2>
          ...
          <div className="mt-2 text-center text-xs text-white/50">
            El precio final se confirma al momento. Puedes ajustar los costos en Inventario.
          </div>
        </div>
      </main>
    </div>
